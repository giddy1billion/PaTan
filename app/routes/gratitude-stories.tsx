...
export const meta: MetaFunction = () => {
  return [
    ...
    },
    {
      name: "description",
      content:
        "Read heartfelt gratitude stories that celebrate life's blessings. Discover how practicing thankfulness transforms perspectives and brings joy to everyday moments.",
    },
    {
      name: "keywords",
      content:
        "gratitude stories, thankfulness testimonies, grateful living, appreciation stories, blessings stories, gratitude journal stories, thankful moments",
    },
    {
      property: "og:title",
      content: "Gratitude Stories | Discover the Power of Thankfulness",
    },
    {
      property: "og:description",
      content:
        "Read heartfelt gratitude stories that celebrate life's blessings.",
    },
...
const featuredStories = [
  {
    ...
    excerpt:
      "It took losing what I had to realize how much I'd been given all along...",
    author: "Jennifer W.",
    readTime: "4 min",
    reactions: 523,
  },
  {
    ...
    excerpt:
      "When I started counting blessings instead of problems, everything changed...",
    author: "Robert M.",
    readTime: "5 min",
    reactions: 412,
  },
...
const gratitudePractices = [
  ...
  },
  {
    ...
    description: "Express appreciation to someone who made a difference",
  },
  {
    icon: "🧘",
    title: "Mindful Moments",
    description: "Pause to notice and appreciate present blessings",
  },
  {
    icon: "🗣️",
    title: "Share Stories",
    description: "Tell others about moments you're grateful for",
  },
];
      ...
      <section className="relative bg-gradient-to-b from-golden/20 to-dawn py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-xl text-night/70 max-w-2xl mx-auto">
            Discover the transformative power of thankfulness through stories
            from people who found joy in appreciating life's gifts, big and
            small.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/discover?category=gratitude"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-center text-night/70 max-w-2xl mx-auto">
            Research shows that practicing gratitude has measurable benefits for
      ...
      <section className="py-20 bg-midnight text-dawn">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-dawn/70">
            Sharing your gratitude amplifies it, for you and for everyone who
            reads it.
          </p>
          <Link
            to="/stories/new"
