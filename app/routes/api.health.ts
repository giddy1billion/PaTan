    ...
    checks: {
      ...
      workers: {
        emailVerificationRetry: {
          ...
          lastRunFinishedAt: worker.lastRunFinishedAt,
          lastRunDurationMs: worker.lastRunDurationMs,
          lastRunOutcome: worker.lastRunOutcome,
          lastRunError: worker.lastRunError,
