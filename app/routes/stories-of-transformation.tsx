...
export const meta: MetaFunction = () => {
  return [
    { title: "Stories of Transformation | Life-Changing Testimonies | PaTan™" },
    {
      name: "description",
      content:
        "Read inspiring stories of personal transformation and life change. Discover testimonies of people who transformed their lives through faith, growth, and determination.",
    },
    {
      name: "keywords",
      content:
        "transformation stories, life change testimonies, personal transformation, life-changing stories, before and after stories, redemption stories, changed lives",
    },
    {
      property: "og:title",
      content: "Stories of Transformation | Life-Changing Testimonies",
    },
    {
      property: "og:description",
      content:
        "Read inspiring stories of personal transformation and life change.",
    },
...
const featuredStories = [
  {
    ...
    excerpt:
      "Twenty years of substance abuse ended the day I decided to become the person I needed when I was struggling...",
    author: "Michael T.",
    readTime: "9 min",
    reactions: 1567,
  },
  {
    ...
    excerpt:
      "Standing at a crossroads, I made a decision that would change everything...",
    author: "Priya S.",
    readTime: "6 min",
    reactions: 823,
  },
  {
    ...
    excerpt:
      "For years I lived someone else's dream. This is how I found my own...",
    author: "Anonymous",
    readTime: "7 min",
    reactions: 945,
  },
...
const transformationTypes = [
  { icon: "🦋", title: "Identity", description: "Discovering your true self" },
  {
    icon: "💚",
    title: "Health",
    description: "Physical and mental wellness journeys",
  },
  {
    icon: "🎯",
    title: "Purpose",
    description: "Finding meaning and direction",
  },
      ...
      <section className="relative bg-gradient-to-br from-midnight via-forest/80 to-midnight text-dawn py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-xl text-dawn/80 max-w-2xl mx-auto">
            Witness the incredible power of change. These are stories of people
            who transformed their lives, their perspectives, and their futures.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/discover?category=transformation"
      ...
      <section className="py-20 bg-midnight text-dawn">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-dawn/70">
            If you've experienced change, big or small, your story could inspire
            someone to begin their own transformation.
          </p>
          <Link
            to="/stories/new"
