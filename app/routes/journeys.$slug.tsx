...
export const meta: MetaFunction = ({ params }) => {
  ...
  return [
    ...
    {
      name: "description",
      content: `Explore stories of ${name.toLowerCase()} from our inspiring community.`,
    },
  ];
};
    ...
    <main id="main-content" className="page-modern">
      ...
      <section className="bg-midnight text-dawn py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-dawn/70">{journey.description}</p>
      ...
      <section className="py-16 bg-mist/30">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-night/70">
            Your experience could inspire someone going through a similar
            journey.
          </p>
