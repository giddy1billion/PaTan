...
export const meta: MetaFunction = () => {
  return [
    {
      title:
        "Overcoming Adversity | Stories of Resilience and Triumph | PaTan™",
    },
    {
      name: "description",
      content:
        "Read powerful stories of people who overcame adversity, challenges, and hardships. Find inspiration in real testimonies of resilience, courage, and triumph.",
    },
    {
      name: "keywords",
      content:
        "overcoming adversity stories, resilience stories, triumph over challenges, overcoming obstacles, hardship testimonies, success against odds, perseverance stories",
    },
    {
      property: "og:title",
      content: "Overcoming Adversity | Stories of Resilience and Triumph",
    },
    {
      property: "og:description",
      content:
        "Read powerful stories of people who overcame adversity and challenges.",
    },
...
const featuredStories = [
  {
    ...
    excerpt:
      "Five years ago I was sleeping under a bridge. Today I run a shelter for those in need...",
    author: "Marcus J.",
    readTime: "8 min",
    reactions: 892,
  },
  ...
  },
  {
    ...
    excerpt:
      "The fire took our home, our possessions, everything. But it couldn't take our spirit...",
      ...
      <section className="relative bg-gradient-to-b from-midnight to-night text-dawn py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-xl text-dawn/80 max-w-2xl mx-auto">
            Stories of remarkable people who faced impossible odds and found a
            way through. Their journeys prove that the human spirit is
            unbreakable.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/discover?category=overcoming-adversity"
          ...
          <div className="mt-12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {challenges.map((challenge) => (
              ...
              >
                ...
                <h3 className="mt-2 font-medium text-midnight text-sm">
                  {challenge.label}
                </h3>
                <p className="text-xs text-night/50">
                  {challenge.count} stories
                </p>
              </Link>
            ))}
          </div>
          ...
          <div className="mt-12 space-y-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-night/70">
                  Everyone faces challenges. Reading these stories reminds us
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-night/70">
                  These storytellers weren't born with special powers, they
                  developed strength through their experiences.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-night/70">
                  Almost every story mentions someone who helped along the way.
      ...
      <section className="py-20 bg-midnight text-dawn">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-dawn/70">
            Your story of resilience could give someone else the courage to keep
            fighting.
          </p>
          <Link
            to="/stories/new"
