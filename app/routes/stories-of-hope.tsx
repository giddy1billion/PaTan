...
export const meta: MetaFunction = () => {
  return [
    {
      title:
        "Stories of Hope | Find Hope Through Real Life Experiences | PaTan™",
    },
    {
      name: "description",
      content:
        "Discover powerful stories of hope from people who found light in dark times. Read real testimonies of faith, perseverance, and the human spirit triumphing over adversity.",
    },
    {
      name: "keywords",
      content:
        "stories of hope, hope stories, finding hope, hopeful testimonies, inspirational hope stories, hope in difficult times, stories of faith and hope",
    },
    {
      property: "og:title",
      content: "Stories of Hope | Find Hope Through Real Life Experiences",
    },
    {
      property: "og:description",
      content:
        "Discover powerful stories of hope from people who found light in dark times.",
    },
...
const featuredStories = [
  {
    ...
    excerpt:
      "After losing everything I thought mattered, I discovered what truly gives life meaning...",
    author: "Maria L.",
    readTime: "6 min",
    reactions: 342,
  },
  {
    ...
    excerpt:
      "I had given up on tomorrow until a stranger's kindness changed everything...",
    author: "David K.",
    readTime: "5 min",
    reactions: 287,
  },
  {
    ...
    excerpt:
      "What I thought was the end turned out to be the beginning of my true journey...",
    author: "Sarah M.",
    readTime: "7 min",
    reactions: 456,
  },
      ...
      <section className="relative bg-gradient-to-b from-midnight via-midnight to-night text-dawn py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-xl text-dawn/80 max-w-2xl mx-auto">
            Real stories from real people who found hope in their darkest
            moments. Let their journeys remind you that light always breaks
            through.
          </p>
          ...
          <div className="mt-12 grid sm:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-night/70">
                Stories of people who rediscovered faith and purpose through
                life's challenges.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="mt-2 text-night/70">
                Testimonies of fresh starts, second chances, and the courage to
                begin again.
              </p>
            </div>
            <div className="text-center">
      ...
      <section className="py-16 bg-dawn">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 prose prose-lg max-w-none text-night/70">
            <p>
              Hope isn't just a feeling, it's a lifeline. When we're struggling,
              hearing that someone else made it through a similar situation can
              make all the difference. These stories aren't about pretending
              everything is perfect. They're about real people facing real
              challenges and finding reasons to keep going.
            </p>
            <p>
              Research shows that hope is strongly linked to mental health,
              resilience, and even physical wellbeing. When we read stories of
              hope, we're not just being entertained, we're building our own
              capacity for hope.
            </p>
            <p>
              Every story shared here is a gift to someone who needs it. Your
              story could be the one that helps a stranger find their footing
              again.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 bg-midnight text-dawn">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-dawn/70">
            If you've found hope in a difficult time, sharing your experience
