...
const floatingStories = [
  { text: "I never thought I would overcome this...", delay: 0, position: 'left-top' },
  { text: "This experience changed my perspective...", delay: 2, position: 'right-middle' },
  { text: "Today, I am grateful because...", delay: 4, position: 'left-bottom' },
];
    ...
    >
      ...
      <div className="absolute inset-0" aria-hidden="true">
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(ellipse 80% 50% at 50% 40%, rgba(245, 185, 66, 0.15) 0%, transparent 60%)',
          }}
        />
        
        {/* Animated gradient orbs */}
        <div className="absolute top-1/4 -left-20 w-96 h-96 bg-golden/20 rounded-full blur-[100px] animate-pulse-slow" />
        <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-forest/20 rounded-full blur-[100px] animate-pulse-slow" style={{ animationDelay: '1.5s' }} />
        ...
        {floatingStories.map((story, index) => {
          ...
          return (
            <div
              key={index}
              className={`
                absolute ${positions[story.position as keyof typeof positions]}
                glass-dark rounded-2xl p-5 max-w-[280px]
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              <span className="block font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-dawn leading-[1.1] tracking-tight">
                Every Story Has the{' '}
                <span className="text-golden">Power</span> to
              </span>
            ...
            <p className="mt-6 sm:mt-8 text-base sm:text-lg lg:text-xl text-dawn max-w-2xl mx-auto leading-relaxed opacity-0 animate-fade-in-up stagger-2 px-4">
              ...
              Reflect on your journey, inspire others, and connect with a community that 
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 opacity-0 animate-fade-in-up stagger-5 hidden sm:block" aria-hidden="true">
