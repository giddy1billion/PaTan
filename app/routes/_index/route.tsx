...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      property: "og:title",
      content: "PaTan™ | Share Stories. Inspire Lives. Connect Through Hope.",
    },
    {
    ...
    {
      name: "twitter:title",
      content: "PaTan™ | Share Stories. Inspire Lives.",
    },
    {
      name: "twitter:description",
      content:
        "Discover hope-filled stories and share your own transformative experiences.",
    },
