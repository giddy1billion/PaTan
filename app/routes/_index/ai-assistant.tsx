        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-lg text-muted leading-relaxed">
              {" "}
              Whether your thoughts are unfinished, emotional, or difficult to
              express, PaTan AI assistant helps transform your experiences into
              meaningful narratives while preserving your authentic voice.{" "}
            </p>{" "}
            {/* Features grid */}{" "}
          ...
          <div className="relative order-1 lg:order-2" aria-hidden="true">
            ...
            <div className="relative bg-white rounded-2xl shadow-layered-lg border border-mist/50 overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-mist/50 to-mist/30 px-4 sm:px-6 py-4 flex items-center gap-3 border-b border-mist/50">
                ...
                <span className="text-sm text-subtle font-medium ml-2">
                  Story Editor
                </span>{" "}
              </div>{" "}
              {/* Editor Content */}{" "}
              <div className="p-4 sm:p-6 lg:p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    {" "}
                    <label className="text-xs text-subtle uppercase tracking-wider font-medium">
                      Title
                    </label>{" "}
                  ...
                  <div>
                    ...
                    <div className="mt-2 text-muted leading-relaxed text-sm sm:text-base">
                      ...
                      <p>
                        {" "}
                        When I first received the news, I didn't know how to
                        process it. The world felt like it was crumbling around
                        me...{" "}
                      </p>{" "}
                ...
                <div className="mt-6 p-4 sm:p-5 bg-gradient-to-br from-golden/10 via-golden/5 to-transparent rounded-xl border border-golden/20">
                  ...
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-golden/20 flex items-center justify-center">
                      {" "}
                      <svg
                        className="w-5 h-5 text-golden-accessible"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        {" "}
                    ...
                    <div>
                      {" "}
                      <div className="text-sm font-semibold text-golden-accessible">
                        AI Suggestion
                      </div>{" "}
                      <p className="text-sm text-muted mt-1 leading-relaxed">
                        {" "}
                        Consider describing the specific moment you felt hope
                        returning. What small sign gave you strength?{" "}
                      </p>{" "}
                    </div>{" "}
                  </div>{" "}
                </div>{" "}
