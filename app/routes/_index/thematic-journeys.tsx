          ...
          {categories.map((category, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Icon */}{" "}
                <div
                  className={` w-12 h-12 sm:w-14 sm:h-14 rounded-xl ${colors.bg} ${colors.iconBg} flex items-center justify-center ${colors.text} transition-colors duration-300 mb-3 sm:mb-4 `}
                >
                  {" "}
                  {category.icon}{" "}
                </div>{" "}
