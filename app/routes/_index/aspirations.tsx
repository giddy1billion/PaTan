...
const timelineItems = [
  ...
  {
    status: "in-progress",
    label: "Building a supportive community",
    date: "Current",
  },
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="relative max-w-md mx-auto lg:max-w-none">
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                {timelineItems.map((item, index) => (
                  <div
                    key={index}
                    className={` flex items-start gap-4 sm:gap-5 opacity-0 animate-slide-in-left `}
                    style={{
                  ...
                  >
                    ...
                    >
                      ...
                      <p
                        className={`text-xs sm:text-sm mt-1 ${item.status === "in-progress" ? "text-golden" : "text-night/50"}`}
                      >
                        {" "}
                        {item.date}{" "}
                      </p>{" "}
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              {" "}
              Celebrate the Journey, <br className="hidden sm:block" />{" "}
            ...
            <p className="mt-4 sm:mt-6 text-base sm:text-lg text-night/70 leading-relaxed">
              {" "}
              Share your hopes, goals, and aspirations. Receive encouragement
              from the community and celebrate milestones along the way.{" "}
            </p>{" "}
            {/* Features grid */}{" "}
            <div className="mt-8 grid grid-cols-2 gap-3 sm:gap-4">
              ...
              {highlights.map((item, index) => (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-night/80">
                    {item.label}
                  </span>{" "}
                </div>
              ))}{" "}
