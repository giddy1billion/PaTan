    ...
    >
      ...
      <div className="absolute inset-0" aria-hidden="true">
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(ellipse 60% 50% at 50% 60%, rgba(245, 185, 66, 0.15) 0%, transparent 70%)',
          }}
        />
        
        {/* Animated gradient orbs */}
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-golden/10 rounded-full blur-[150px] animate-pulse-slow" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-forest/10 rounded-full blur-[120px] animate-pulse-slow" style={{ animationDelay: '1.5s' }} />
      </div>
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <span className="text-dawn">Someone May Need the Story</span>
          <br />
