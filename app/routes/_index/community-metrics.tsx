  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" aria-hidden="true">
        ...
        <div
          className="absolute bottom-0 right-1/4 w-96 h-96 bg-forest/10 rounded-full blur-[120px] animate-pulse-slow"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-6 sm:gap-8 lg:grid-cols-4">
          ...
          {metrics.map((metric, index) => (
            <div
              key={metric.label}
              className={` relative text-center p-6 sm:p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 opacity-0 animate-fade-in-up `}
              style={{
        ...
        <p className="mt-12 sm:mt-16 text-center text-dawn text-sm sm:text-base max-w-2xl mx-auto">
          {" "}
          Every number represents a real person whose story created hope for
          another. Your story could be the next ripple.{" "}
        </p>{" "}
      </div>{" "}
    </section>
  );
