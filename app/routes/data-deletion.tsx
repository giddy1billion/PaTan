    ...
    <main id="main-content" className="page-modern bg-dawn">
      <section className="bg-midnight text-dawn py-14 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-heading text-3xl sm:text-4xl font-bold">User Data Deletion</h1>
      ...
      <section className="py-10 sm:py-12 lg:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="space-y-8 rounded-2xl border border-midnight/10 bg-white p-6 sm:p-8 shadow-sm">
            ...
            <section className="space-y-3">
              <h2 className="font-heading text-2xl text-midnight font-bold">Processing timeline</h2>
              <p className="text-night/80 leading-relaxed">
                We confirm receipt within 72 hours and complete deletion within 30 days, unless retention is required
                by law, abuse prevention, or security obligations.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="font-heading text-2xl text-midnight font-bold">What gets deleted</h2>
              <ul className="space-y-2 text-night/80 leading-relaxed list-disc pl-6">
                ...
                <li>Stories, aspirations, comments, and related user-generated content tied to your account.</li>
                <li>Associated account metadata not required for legal or security purposes.</li>
              </ul>
            </section>

            <section className="space-y-3">
              <h2 className="font-heading text-2xl text-midnight font-bold">Contact</h2>
              <p className="text-night/80 leading-relaxed">
