...
export const meta: MetaFunction = () => {
  return [
    { title: "Community Guidelines | PaTan™" },
    {
      name: "description",
      content:
        "PaTan™ community guidelines for respectful, supportive storytelling and engagement.",
    },
  ];
};
...
const guidelines = [
  {
    ...
    description:
      "Tell your own story in your own words. Authenticity creates genuine connection.",
    dos: [
  ...
  },
  {
    ...
    description:
      "Our community includes people from all backgrounds, beliefs, and perspectives.",
    dos: [
      "Celebrate diversity",
      "Listen with empathy",
  ...
  },
  {
    ...
    description:
      "Honor the privacy of yourself and others mentioned in your stories.",
    dos: [
      "Get consent before sharing others' stories",
      "Use discretion with identifying details",
      "Respect anonymity choices",
    ],
    donts: [
      "Share others' personal information",
      "Reveal confidential details",
      "Identify people without consent",
    ],
  },
  {
    ...
    donts: [
      "Make comparisons",
      "Diminish others' experiences",
      "Promote competitive dynamics",
    ],
  },
  {
    title: "Maintain Emotional Safety",
    description:
      "Be mindful that others may be in vulnerable moments when reading stories.",
    dos: [
    ...
    donts: [
      "Post gratuitously graphic content",
      "Trivialize trauma",
  ...
  },
  {
    ...
    donts: [
      ...
      "Exploit mental health struggles",
    ],
  },
];
    ...
    <main id="main-content" className="page-modern">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-dawn/70">
            Together, we create a sanctuary for authentic storytelling and
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl p-8 shadow-sm border border-mist">
            ...
            <p className="mt-4 text-night/70 leading-relaxed">
              PaTan™ is built on the belief that every story matters and every
              voice deserves to be heard. These guidelines exist not to
              restrict, but to protect, ensuring that everyone in our community
              feels safe to share their most authentic selves.
            </p>
            <p className="mt-4 text-night/70 leading-relaxed">
              By participating in PaTan™, you agree to uphold these principles
              and help us maintain a space where hope, healing, and human
          ...
          <div className="space-y-8">
            {guidelines.map((guideline, index) => (
              ...
              >
                ...
                <p className="mt-4 text-night/70">{guideline.description}</p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl p-8 shadow-sm border border-mist">
            ...
            <p className="mt-4 text-night/70">
              ...
              guidelines, please report it using the report button on any story
              or profile. Our moderation team reviews all reports within 24
              hours.
            </p>
            <p className="mt-4 text-night/70">
      ...
      <section className="py-16 bg-mist/30">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-night/70">
            By following these guidelines, you help us maintain a space where
            everyone can share their story with confidence.
          </p>
