...
export const meta: MetaFunction = () => {
  return [
    { title: "Thematic Journeys | PaTan™" },
    {
      name: "description",
      content:
        "Explore curated collections of stories organized by life themes and experiences.",
    },
  ];
};
...
const journeys = [
  {
    ...
    icon: "🙏",
    description:
      "Stories celebrating thankfulness and appreciation for life's blessings.",
    storiesCount: 1567,
  ...
  },
  {
    ...
    icon: "🌅",
    description:
      "Journeys of spiritual growth, faith, and finding hope in difficult times.",
    storiesCount: 1247,
  ...
  },
  {
    ...
    icon: "💪",
    description:
      "Powerful stories of resilience, courage, and triumph over challenges.",
    storiesCount: 892,
  ...
  },
  {
    ...
    icon: "💚",
    description:
      "Healing journeys, recovery stories, and paths to physical and mental wellness.",
    storiesCount: 634,
  ...
  },
  {
    ...
    icon: "❤️",
    description:
      "Stories of love, family, friendship, and meaningful human connections.",
    storiesCount: 1023,
  ...
  },
  {
    ...
    icon: "📈",
    description:
      "Career transformations, entrepreneurship journeys, and professional breakthroughs.",
    storiesCount: 445,
  ...
  },
  {
    ...
    icon: "🏆",
    description:
      "Victories big and small, moments of achievement and personal growth.",
    storiesCount: 723,
  ...
  },
  {
    ...
    icon: "🌍",
    description:
      "Stories of making a difference in communities and changing lives.",
    storiesCount: 312,
  ...
  },
  {
    ...
    icon: "🦋",
    description:
      "Life-changing moments and the journeys of becoming who we're meant to be.",
    storiesCount: 856,
    color: "from-golden/20 to-forest/20",
  },
  {
    ...
    icon: "✨",
    description:
      "Stories that spark motivation, creativity, and positive action.",
    storiesCount: 978,
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-dawn/70">
            Curated collections of stories that speak to shared human
            experiences.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {journeys.map((journey) => (
              ...
              >
                <article
                  className={`h-full p-6 rounded-xl bg-gradient-to-br ${journey.color} border border-mist hover:shadow-lg transition-all`}
                >
      ...
      <section className="py-16 bg-mist/30">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-night/70">
            Every transformative experience begins with a single step. Share
            your story and inspire others on their path.
          </p>
