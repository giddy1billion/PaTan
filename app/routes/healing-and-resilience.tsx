...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: 'keywords',
      content: 'healing stories, resilience stories, recovery testimonies, trauma recovery, healing from loss, mental health recovery, emotional healing stories',
    },
    { property: 'og:title', content: 'Healing and Resilience Stories – Recovery Journeys' },
    { property: 'og:description', content: 'Read powerful stories of healing and resilience from people who recovered from trauma and hardship.' },
...
const featuredStories = [
  ...
  },
  {
    ...
    excerpt: 'Depression told me I was broken. Recovery taught me I was healing...',
    author: 'Anonymous',
    readTime: '7 min',
    reactions: 2134,
  },
  {
    ...
    excerpt: 'Trust was shattered, but I found a way to trust again—starting with myself...',
    author: 'Rachel K.',
    readTime: '6 min',
    reactions: 987,
  },
...
const healingPaths = [
  { icon: '💚', title: 'Physical Healing', description: 'Recovery from illness and injury' },
  { icon: '🧠', title: 'Mental Health', description: 'Depression, anxiety, and beyond' },
  { icon: '💔', title: 'Grief & Loss', description: 'Finding peace after goodbye' },
  { icon: '🕊️', title: 'Trauma Recovery', description: 'From survival to thriving' },
  { icon: '💑', title: 'Relationship Healing', description: 'Mending broken bonds' },
  { icon: '🌊', title: 'Emotional Wellness', description: 'Processing and growing' },
];
      ...
      <section className="relative bg-gradient-to-b from-forest/80 via-midnight to-night text-dawn py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-xl text-dawn/80 max-w-2xl mx-auto">
            Stories from people who walked through pain and found their way back to 
            wholeness. Proof that healing is possible.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/discover?category=health-wellness" className="btn-primary text-lg px-8 py-4">
      ...
      <section className="py-4 bg-golden/10 border-y border-golden/20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm text-night/70">
            <strong className="text-midnight">A gentle note:</strong> Some stories in this section 
            discuss difficult topics including trauma, mental health struggles, and loss. 
      ...
      <section className="py-16 bg-dawn">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-center text-night/70">
            Everyone's journey is different. Find stories that resonate with yours.
          </p>
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {healingPaths.map((path) => (
              ...
              >
                ...
                <h3 className="mt-4 font-heading text-lg font-bold text-midnight">{path.title}</h3>
      ...
      <section className="py-16 bg-mist/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <Link to="/discover?category=health-wellness" className="btn-secondary">
              View All Stories
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 space-y-6">
            <div className="p-6 bg-forest/5 rounded-xl border-l-4 border-forest">
              <h3 className="font-heading text-lg font-bold text-midnight">Healing isn't linear</h3>
              <p className="mt-2 text-night/70">There will be setbacks. Progress isn't always visible. That's normal.</p>
            </div>
            <div className="p-6 bg-forest/5 rounded-xl border-l-4 border-forest">
              <h3 className="font-heading text-lg font-bold text-midnight">You don't have to do it alone</h3>
              <p className="mt-2 text-night/70">Every story mentions support—friends, family, professionals, communities.</p>
            </div>
            <div className="p-6 bg-forest/5 rounded-xl border-l-4 border-forest">
              <h3 className="font-heading text-lg font-bold text-midnight">Time is part of the medicine</h3>
              <p className="mt-2 text-night/70">Healing takes time. These stories span months and years, not days.</p>
            </div>
            <div className="p-6 bg-forest/5 rounded-xl border-l-4 border-forest">
              <h3 className="font-heading text-lg font-bold text-midnight">Scars can become stories</h3>
              <p className="mt-2 text-night/70">What once hurt can become what helps others. Pain can become purpose.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-mist/30">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-night/70">
            If you're struggling, please reach out to a mental health professional or 
            crisis helpline. Reading stories can provide comfort, but it's not a substitute 
      ...
      <section className="py-20 bg-midnight text-dawn">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-dawn/70">
            If you've walked through darkness and found light, sharing your story could 
